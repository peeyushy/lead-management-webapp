...
public class UserController {
	...
	public String showAddUserPage(ModelMap model, @RequestParam String id) {
		model.put("action", "Add");
		Map<String, String> roleMap = new LinkedHashMap<String, String>();
		for (AppConstants.RoleNames role : userService.getAllRoles()) {
	...
	public String addUser(ModelMap model, @RequestParam String id, @Valid User user, BindingResult result,
			final RedirectAttributes redirectAttributes) {
		if (result.hasErrors()) {
			return "user";
		} else {
	...
	public String updateUser(ModelMap model, @RequestParam String uid, @Valid User user,
